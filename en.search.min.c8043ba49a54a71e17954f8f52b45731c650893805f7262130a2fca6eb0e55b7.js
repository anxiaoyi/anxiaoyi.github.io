...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.13a0dd66568ff20a19122c1aac161695082d8fd9a678572c383cdd7db75022e5.js',function(){input.required=false;search();});}
