...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.931758666a6fd489910f602713b833acb72f53f2d226c11b2750a80e71fa28c2.js',function(){input.required=false;search();});}
