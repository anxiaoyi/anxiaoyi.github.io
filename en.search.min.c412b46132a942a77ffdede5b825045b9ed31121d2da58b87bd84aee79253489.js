...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.79cbc71f3022498b9b1e798c99b65a548dda52e9eddf7df271fd123e942bd5a7.js',function(){input.required=false;search();});}
