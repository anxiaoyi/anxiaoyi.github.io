...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.1665f5b13741e4d847a960e6cf874c4644f1596867a9ae1be03e28dfa69f2f35.js',function(){input.required=false;search();});}
