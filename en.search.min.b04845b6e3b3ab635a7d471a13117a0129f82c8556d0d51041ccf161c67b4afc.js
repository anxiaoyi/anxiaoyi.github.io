...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.bccd1342a70ee0e00dcdb409c2738cf18c1fa009219c53120cdf1082c227ef14.js',function(){input.required=false;search();});}
