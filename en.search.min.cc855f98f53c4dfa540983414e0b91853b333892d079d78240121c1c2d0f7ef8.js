...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.55df622d915c058838f311499618da717535de01b86c129188331ffa2abc6f81.js',function(){input.required=false;search();});}
