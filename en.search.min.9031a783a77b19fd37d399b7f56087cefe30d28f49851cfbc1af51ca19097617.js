...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.ebc86a34afcec8cfdab1357f31dffede14e92f3af8e4b4cabcb425c4543dcafd.js',function(){input.required=false;search();});}
