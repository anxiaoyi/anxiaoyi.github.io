...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.9624912ae857c471a99a7fa0d07f2ca56d5b70aa82a64e5cbbe7987fcbfe9331.js',function(){input.required=false;search();});}
