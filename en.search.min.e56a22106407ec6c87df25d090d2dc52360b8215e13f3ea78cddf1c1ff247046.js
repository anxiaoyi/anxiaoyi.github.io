...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.32dd372d0acb24fb9c60685d5d6a2072817603325b309bd60bcb8ccb0b8fd750.js',function(){input.required=false;search();});}
