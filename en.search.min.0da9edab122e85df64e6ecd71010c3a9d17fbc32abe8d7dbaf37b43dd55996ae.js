...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.9b88e79ddecba8af571fc0156b7b99ec9d157fc45ea3e3a6e204bcfa054c25a2.js',function(){input.required=false;search();});}
