...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.ecc70eecc520841fed3b24fae5cf23df3d6e0c30bdebf131130fff6d3e7a89d5.js',function(){input.required=false;search();});}
