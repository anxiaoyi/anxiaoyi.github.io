...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.4d517ff9088fd6188b000493091573022a016ecea5e558bdfe45cf5eb517f9d3.js',function(){input.required=false;search();});}
