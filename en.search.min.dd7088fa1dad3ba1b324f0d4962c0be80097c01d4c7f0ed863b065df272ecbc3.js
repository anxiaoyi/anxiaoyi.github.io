...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.f21dd6e6bdd6efb7719f6eff886709e3719e2780482d2b14d0a3fb68810c6f32.js',function(){input.required=false;search();});}
