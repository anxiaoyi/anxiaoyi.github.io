...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.60d815d4e6d125208d85844dc6b44fc74a057195dc4814654fc016abce4580b3.js',function(){input.required=false;search();});}
