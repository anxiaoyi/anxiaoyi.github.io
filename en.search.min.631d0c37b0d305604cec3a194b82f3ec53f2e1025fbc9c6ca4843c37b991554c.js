...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.05d0e3682afb7dd8f2701810e2b77b8596bdb2354a7f71837099666277a1d4d7.js',function(){input.required=false;search();});}
