...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.abd9dd8e3627de400879d7bf34c6172a9507abad688445437324b00f97a9936a.js',function(){input.required=false;search();});}
