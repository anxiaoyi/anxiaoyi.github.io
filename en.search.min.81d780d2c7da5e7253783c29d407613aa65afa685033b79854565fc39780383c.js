...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.9fce886cc784bdafbdb07a0bfca4f7366554ae83f5364ade1524b1917607412e.js',function(){input.required=false;search();});}
