...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.0bd12bda8bf6afe8e323e8e47c892c0a4f7edb5b54b2d14d47d1155b8dfa5eb5.js',function(){input.required=false;search();});}
