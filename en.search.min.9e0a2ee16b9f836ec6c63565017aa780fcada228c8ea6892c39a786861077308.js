...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.9de3ba2a0443f95731a7a06a5c1547b936a992d581b826050e6319c7defb57fa.js',function(){input.required=false;search();});}
