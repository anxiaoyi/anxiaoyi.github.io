...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.3b26626df9d2fc9324db0e6ed792eacdffe74dc3988c5e93cca877d2a6a6be53.js',function(){input.required=false;search();});}
