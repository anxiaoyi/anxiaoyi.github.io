...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.6443daa0aeedb7fbc0b6a3cad99be4c21fae8b87c2a87776fb2ce8c62bcf99f1.js',function(){input.required=false;search();});}
