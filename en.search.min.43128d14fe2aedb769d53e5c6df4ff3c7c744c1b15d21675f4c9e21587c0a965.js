...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.deb3b6d8e549283531893b7cc10b9e3f5a6e9b809e3a27718a366fa70a6beb11.js',function(){input.required=false;search();});}
