...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.4b8103aefc6003f11c20115bd4e0fe5b766300cecb38d7f696ff799a7090c978.js',function(){input.required=false;search();});}
