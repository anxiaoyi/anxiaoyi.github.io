...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.17e675cd2a70efcc5698b93ebbf76c9cda4410afaefa6ebec161e2726be2e479.js',function(){input.required=false;search();});}
